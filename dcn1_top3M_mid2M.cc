...
int main(int argc, char *argv[])
{
    ...
    csma2.SetChannelAttribute("DataRate", StringValue("2.0Mbps"));
   ...
   // csma3.EnablePcap ("Pattern1_n6_to_n2",csmaNode1Devices1.Get(2),true);
    ...
    pointToPoint1.EnablePcap ("Pattern1_top3M_mid2M_c1",p2pDevices1.Get(0), true);
    csma2.EnablePcap ("Pattern1_top3M_mid2M_t1",toR1Devices1.Get(1), true);
    csma2.EnablePcap ("Pattern1_top3M_mid2M_t3",toR2Devices2.Get(1), true);
    csma3.EnablePcap ("Pattern1_top3M_mid2M_n1",csmaNode1Devices3.Get(1),true);
    csma3.EnablePcap ("Pattern1_top3M_mid2M_n6",csmaNode1Devices1.Get(2),true);
