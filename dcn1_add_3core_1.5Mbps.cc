...
NS_LOG_COMPONENT_DEFINE("DCN1_add_3core");
...
int main(int argc, char *argv[])
{
   ...
   //安装P2P网卡设备到P2P网络节点
    ...
    csma2.SetChannelAttribute("DataRate", StringValue("1.5Mbps"));
   ...
   // csma3.EnablePcap ("Pattern1_n6_to_n2",csmaNode1Devices1.Get(2),true);
    ...
    pointToPoint1.EnablePcap ("Pattern1_add_3core_1.5M_c1",p2pDevices1.Get(0), true);
    pointToPoint3.EnablePcap ("Pattern1_add_3core_1.5M_c2",p2pDevices3.Get(0), true);
    pointToPoint5.EnablePcap ("Pattern1_add_3core_1.5M_c3",p2pDevices5.Get(0), true);
    pointToPoint7.EnablePcap ("Pattern1_add_3core_1.5M_c4",p2pDevices7.Get(0), true);
    csma2.EnablePcap ("Pattern1_add_3core_1.5M_t1", toR1Devices1.Get(1), true);
    csma2.EnablePcap ("Pattern1_add_3core_1.5M_t3", toR2Devices2.Get(1), true);
    csma3.EnablePcap ("Pattern1_add_3core_1.5M_n1", csmaNode1Devices3.Get (1), true);
    csma3.EnablePcap ("Pattern1_add_3core_1.5M_n6", csmaNode1Devices1.Get (2), true);
