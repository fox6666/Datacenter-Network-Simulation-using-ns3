...
NS_LOG_COMPONENT_DEFINE("DCN_pattern2_3Mbps");
...
int main(int argc, char *argv[])
{
    ...
    csma3.SetChannelAttribute("DataRate", StringValue("3Mbps"));
   ...
   // csma3.EnablePcap ("Pattern1_n6_to_n2",csmaNode1Devices1.Get(2),true);
    ...
    pointToPoint1.EnablePcapAll ("Pattern2_p2p_3Mbps");
    //csma2.EnablePcapAll ("csma2");
    csma3.EnablePcapAll ("Pattern2_cama3_3Mbps");
